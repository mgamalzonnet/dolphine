...
const WalletBalance = () => {
  ...
  return (
     <ProfileCard className="h-[178px] flex flex-col items-center justify-center gap-4 p-6">
      ...
      <ProfileButtons variant="outline" size="sm" className="w-[210px] mt-2 cursor-pointer" onClick={() => navigate("/balance-details")}>
        ...
        />
        <span className="text-navyteal font-semibold text-sm md:text-[16px]">تفاصيل الرصيد</span>
      </ProfileButtons>
    </ProfileCard>
  )
}
